...
export default function AboutUs() {
  return (
    <>
      ...
      >
        <h2 className="mb-4 text-center text-3xl font-bold leading-tight tracking-tighter text-heading  md:text-5xl">
          About The Alliance
        </h2>
        <div className="container mx-auto px-4">
          <div className="-mx-4 flex flex-wrap">
            <div className="mb-5 w-full px-4 lg:mb-0 lg:w-1/2">
              <p className="mb-6 text-lg font-semibold leading-8 text-coolGray-500 md:text-xl">
                Bringing you within arms length of the help you need to live a
                happy and pressure free lifestyle.
              </p>
              <p className="mb-5 text-lg leading-7 text-coolGray-500">
                The Mental Health Alliance is aimed to link you, your family
                member,loved one or friend to the various mental health services
                that may be required. We are connecting you to different mental
                health organisation that offer a various range of services. We
                provide you with a user friendly platform that allows you to
                browse through easily and find the help you need.
              </p>
              <h3 className="mb-5 text-3xl font-bold tracking-tighter text-heading md:text-4xl">
                Goal
              </h3>
              <p className="mb-5 text-lg leading-7 text-coolGray-500">
                To lead each and every Individual towards the help they need.
              </p>
              <h3 className="mb-5 text-3xl font-bold tracking-tighter text-heading md:text-4xl">
                Objective
              </h3>
              <p className="text-lg leading-7 text-coolGray-500">
                To become the regions number one mental health service hub, for
                people of all ages to access mental health services.
              </p>
            </div>
            <div className="w-full px-4 lg:w-1/2">
              <p className="mb-5 text-lg leading-7 text-coolGray-500">
                <span>
                  Our organisation is free and open to receiving members that
                  offer any mental health services. One does not entirely need
                  to be involved with an organisation to be a member, but can be
                  an independent and licensed practitioner. Our doors are open
                  to all those that know they can make a difference to the lives
                  of many, regarding their mental health. Our service to you is
                  built on the foundations of the three qualities listed below:
                </span>
              </p>
              <ol className="mb-5 list-inside list-decimal text-lg leading-7 text-coolGray-500">
                <li>
                  <span className="text-lg leading-8 text-coolGray-500">
                    Trust.
                  </span>
                </li>
                <li>
              ...
              <p className="text-lg leading-7 text-coolGray-500">
                ...
                only remembers to turn on the light", we as the Mental Health
                Alliance act as your light.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="-mx-4 flex flex-wrap">
            <div className="mb-12 w-full px-4 md:mb-0 md:w-1/3">
              <div className="mx-auto max-w-xs text-center">
                <div className="w-18 h-18 mb-6 inline-flex items-center justify-center rounded-full bg-blue-500">
                  <svg
                ...
                <h3 className="mb-2 text-2xl font-bold leading-9 text-heading md:text-3xl">
                  Email
                </h3>
                <p className="mb-4 text-lg font-medium leading-7 text-coolGray-500 md:text-xl">
                  You can email us on
                </p>
                <a
                  className="text-lg font-medium text-blue-500 hover:text-blue-600 md:text-xl"
                  href="mailto:#"
                >
            ...
            <div className="mb-12 w-full px-4 md:mb-0 md:w-1/3">
              <div className="mx-auto max-w-xs text-center">
                ...
                <p className="text-lg font-medium text-blue-500 md:text-xl">
                  +260-772-773-447
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/3">
              <div className="mx-auto max-w-xs text-center">
                ...
                <p className="mb-4 text-xl font-medium leading-7 text-coolGray-500">
                  Our offices are located at
                </p>
                <p className="text-lg font-medium text-blue-500 md:text-xl">
                  57, Lukanga Road, Roma
                </p>
                <p className="text-lg font-medium text-blue-500 md:text-xl">
                  Lusaka, Zambia 10101
                </p>
